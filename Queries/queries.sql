...
-- Joining retirement_info and dept_emp tables to create new table and identifies who still works at PH
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
de.to_date
...
INTO department_retiring_breakdown
...
-- Skill drill.. Projected retiring Sales Department Only
SELECT ce.emp_no,ce.first_name,ce.last_name,d.dept_name
-- INTO dept_info
FROM current_emp AS ce
INNER JOIN dept_emp AS de
...
-- Skill drill .. projected retiring Sales and Development Department
SELECT ce.emp_no,ce.first_name,ce.last_name,d.dept_name
-- INTO dept_info
FROM current_emp AS ce
INNER JOIN dept_emp AS de
